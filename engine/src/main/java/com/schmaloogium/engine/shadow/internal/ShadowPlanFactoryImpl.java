...
public final class ShadowPlanFactoryImpl implements ShadowPlanFactory {
    ...
    private static String fingerprintPreimage(ShadowPlanInput input) {
        ...
        preimage.append("shadowDistance=").append(Float.toString(policy.shadowDistance())).append('\n')
                ...
                .append("shadowTerrain=").append(policy.content().terrain()).append('\n')
                .append("shadowEntities=").append(policy.content().entities()).append('\n')
                .append("shadowBlockEntities=").append(policy.content().blockEntities()).append('\n')
                .append("shadowPlayer=").append(policy.content().player()).append('\n')
