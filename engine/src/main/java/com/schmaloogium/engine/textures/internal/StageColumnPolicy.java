 ...
 * column members in which expanded stage. The base aliases tex/texture/gtexture share
 * GBUFFERS and SHADOW; companions and fullscreen aliases keep their documented columns.
...
public final class StageColumnPolicy {
    ...
    public static Set<StageId> legalStages(FixedSamplerName name) {
        return switch (name) {
            case TEXTURE, TEX, GTEXTURE -> WORLD;
            case LIGHTMAP -> WORLD;
