...
**Date:** 2026-09-08 · Attempt-11 fix-up wave (§G1.3). Certified-bytes SHA-256 (pre-fix-up): `05abca4b2fa4c0b7dc1bf3a8f4a13ac8543b5b5e2d64134d3a471217153abb47`. Post-fix-up SHA-256: `8395347f99f9d28ab49b33172e7621ac162a0497d063b3bc21b9ece63ce98c0a`.

- **F-38-1 (correction) — resolved.** The fabricated §3.5 attribution for "GLSL 120 has no `gl_InstanceID`" is dropped/re-sourced at every site. Ll. 1921 and 4150: "(RESEARCH.md §3.5)" replaced with "(engine-general OpenGL/GLSL-120 knowledge)" in place. L. 6174: "GLSL 120 has neither (RESEARCH.md §3.5)" → "GLSL 120 has neither (engine-general OpenGL/GLSL-120 knowledge)". Historical §0 addendum (review's l. 206 pointer): the attributed occurrence in that addendum actually sits at ll. 224–225 ("§3.5 (GLSL 120 has no `gl_InstanceID`)"); cured by deleting the §3.5 attribution and re-stating the GL fact as engine-general OpenGL knowledge beside App D.4's int-uniform citation, the fact that source actually carries (App D.4 l. 1378 re-verified before the edit: "`instanceId` | int | 0 original, 1..N instanced copies"). Ll. 206 and 6518 (§11.4) were verified by grep to state the clause with **no** source attribution; they already satisfy the cure's end state (a true GL fact, uncited) and were left byte-identical. Verification: `grep -n 'gl_InstanceID'` returns six occurrences (ll. 206, 225, 1921, 4150, 6174, 6518), none with §3.5 adjacency; the only remaining `RESEARCH.md §3.5)` is l. 1902's extension-set row, a different, correctly grounded fact. §5 untouched; line count 7,053 unchanged; every edit same-line-count in place.
- **F-38-2 (correction) — resolved.** Ll. 691–692 corrected in place, addendum intent kept: the §4.2 half now reads "the ~90 built-in uniforms and the 60 slots" and the App A.1 half "what the 60 actually counts; the 43-slot figure is DESIGN.md's, RC2 l. 570". Targets re-verified at source before repointing: RESEARCH.md l. 494 ("60 classic program slots"), l. 505 ("~90 built-in uniforms"), App A.1 ll. 1143–1144 ("Count: 60 named shader/virtual slots"), RC2 l. 570 ("43 slots"). Zero line-count change. One evidence note for the record: the finding's "no other '43' in the document" does not match current bytes — further "43" occurrences exist in historical §0 addenda (ll. 265, 277, 392, 411, 675–678, 820–821, e.g. l. 411's "(RESEARCH.md l. 493 says 43 *slots*)"); the correction orders only ll. 691–692, so those dated records were left untouched.
- **N-38-1 (note) — disposition: no action, recorded-only.** L. 1079 read and confirmed as the described dated 2026-07-26 §0.12 remark; the current Phase 2 document is `docs/phase2/v2/PHASE_2_DOC.md` and the doc's historical-addenda convention covers the stale name. No edit made.

The document's closing-status block (former "Current §G1.3 status — §0.35", ll. 7045–7053) was updated in place, same line count, to the 2026-09-08 attempt-11 wave close-out wording: review 38 PASS-WITH-CORRECTIONS (0 blocking, 2 corrections, 1 note), all corrections applied and resolutions recorded, no §5 change outstanding — **verified** per §G1.3.
