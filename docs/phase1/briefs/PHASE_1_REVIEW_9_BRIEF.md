...
The cadence: build session → eight verify sessions (PHASE_1_REVIEW_1.md … _8.md, every one
...
`docs/phase1/reviews/PHASE_1_REVIEW_9.md`, following rounds seven and eight's established shape:
