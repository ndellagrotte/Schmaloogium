...
**Date:** 2026-09-08 · Attempt-11 fix-up wave (§G1.3). Certified-bytes SHA-256 (pre-fix-up): `fe2206dc934f5cbf432048e89b6fda36fec1acfd91c715ad37e724b3d1fd585c`. Post-fix-up SHA-256: `4e94d087b31c06021444b20687185c0f032dcf870438cc772caf3d3cb8768481`.

- **F-1 (correction) — resolved.** Both stale P13 pins repointed from `docs/phase13/v1/PHASE_13_DOC.md:846-852` to `:865-877` — §0.55 (l. 360) and the §0.67 repair record (l. 624). Target verified against current P13 bytes before editing: §4.1.6 "`MC_NORMAL_MAP` / `MC_SPECULAR_MAP` wiring" heading at l. 865, the required `CompanionOptionMacros(boolean normalMap,boolean specularMap)` pair "immediately after engineOptions" at l. 868, "Off short-circuits" at l. 872, and the materializer wording "Empty/DefineCenterDepthSmooth, not a general macro bag" at ll. 875–876; the old 846–852 range is §4.1.5 "Publication and stage applicability" tail as the review stated. In-place same-line substitutions; no §5 bytes touched.
- **F-2 (correction) — resolved.** All three stale P4 pins repointed from `docs/phase4/v1/PHASE_4_DOC.md:2263-2266` to `:2279-2283` — §0.57 (l. 426), D-P3-60 (l. 5111), and the §0.67 record (l. 629). Target verified against current P4 bytes before editing: §5.4 "Requested changes to dependency contracts" begins at l. 2271, item 2 "Phase 3 native source and registry projections: owner-granted/unverified, receiver-adopted/unverified" spans ll. 2279–2283 with the quoted "direct `mipmappedAfterPass()`/`vertices()` values" verbatim at l. 2282; the old 2263–2266 range is the §5.3 consumed-contracts table tail as the review stated. In-place same-line substitutions; no §5 bytes touched.
- **N-1 (note) — disposition: no action (recorded-only).** §0.1's dependency-review status (ll. 25–26) is the original build session's assignment record; per the review it remains accurate as a build-time record, the review's own independent verification of the current P1 §5 discharges the dependency gate, and the registry's whole-owner re-review supersedes dependency-status bookkeeping — so no doc edit is made.

Wave verification: `wc -l` unchanged at 5581 (zero line-count drift anywhere; sibling citation pins at :3258-3285 and :3903-3905 remain coordinate-valid); grep confirms zero remaining `846-852`/`2263-2266` tokens and exactly 2× `:865-877` plus 3× `:2279-2283`; §5 untouched. Closing status updated in place (same line counts) at §0.67 (ll. 641–643) and the doc tail (ll. 5577–5581): attempt-11 review PASS-WITH-CORRECTIONS — 0 blocking, 2 corrections, 1 note — all corrections applied, resolutions recorded here, verified per §G1.3.
