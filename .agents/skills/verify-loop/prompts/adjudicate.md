...
You may create exactly `{{REVIEW_FILE}}` and may modify no other path. The orchestrator hashes the
worktree and immutable evidence before and after this session and rejects any out-of-scope write.
