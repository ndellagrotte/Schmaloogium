...
A tool-level guard blocks any other write before it executes, and the orchestrator hashes the
worktree and immutable evidence before and after this session and rejects any other write.
Prior reviews other than the current round, authoritative specifications,
